...
print(int(input()))
```
![Меню](picturies/С2.3.1.png)
![Меню](picturies/С2.3.2.png)
...
- Также со строками тоже можно производить множество разных операций. Разделять и складывать, регулировать регистр, измерять длину строк, менять символы местами и работать с индесами символов и слов в предложении
